...
class TaskController extends BaseController
{
    ...
    public function getArtist($id)
    {
        ...
        $name = '';
        foreach ($artist as $n): $name = $artist['Name']; endforeach;
        //var_dump($artist);
    ...
    public function getAlbum($id)
    {
        ...
        $genreName ='';
        foreach ($genre as $g): $genreName = $g['Name']; endforeach;
        return View::make('album', ['id' => $id, 'tracks' => $tracks, 'genre'=>$genreName, 'artist' =>$artist]);
    }
    ...
    public function getTrack($id)
    {
        ...
        return View::make('track', ['track' => $track, 'genre' => $genre, 'artist' =>$artist, 'album' => $album]);
    }
